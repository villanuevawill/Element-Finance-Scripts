...
async function proposal() {
  ...
  const votingCallData = coreVotingInterface.encodeFunctionData('setDefaultQuorum', [
    "2770000000000000000000000",
  ]);

  callData.push(votingCallData)
  targets.push(CoreVoting)
